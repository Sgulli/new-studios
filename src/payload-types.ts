...
export interface Plan {
  id: number;
  /**
   * e.g. Monthly, Annual, 10 Entries
   */
  name: string;
  /**
   * Short description for listino and admin
   */
  description?: string | null;
  /**
  ...
  price: number;
  /**
   * Length of the plan (e.g. 1 month, 12 months)
   */
  duration: number;
  /**
   * Unit for duration
  ...
  /**
   * Inactive plans are hidden from public listino
   */
  active?: boolean | null;
  updatedAt: string;
  createdAt: string;
